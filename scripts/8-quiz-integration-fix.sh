...
# =====================================================
# SCRIPT 8: CORREÇÃO QUIZ NA SEÇÃO EXISTENTE - PARTE 1
# Portal "Jesus é o Pão da Vida"
# Integrar quiz na seção quiz existente do index.html
# =====================================================
# Uso: chmod +x 8-quiz-integration-fix.sh && ./8-quiz-integration-fix.sh
# =====================================================

set -e

echo "🔧 CORREÇÃO QUIZ - INTEGRAÇÃO NA SEÇÃO EXISTENTE"
...
# Backup
echo "💾 Backup..."
BACKUP_DIR="backup-quiz-fix-$(date +%Y%m%d_%H%M%S)"
mkdir -p "$BACKUP_DIR"
cp index.html "$BACKUP_DIR/"
cp js/quiz-biblico.js "$BACKUP_DIR/" 2>/dev/null || true
echo "   ✅ Backup: $BACKUP_DIR"

# ============================================
# PASSO 1: LIMPAR HTML DUPLICADO
# ============================================
echo ""
echo "🧹 PASSO 1: Limpando seções duplicadas..."

# Verificar seções duplicadas
QUIZ_COUNT=$(grep -c "quiz-section\|Quiz Bíblico" index.html || echo "0")
echo "   📊 Seções quiz encontradas: $QUIZ_COUNT"

# Remover seção duplicada do final
if grep -q "<!-- ===== SEÇÃO QUIZ BÍBLICO ===== -->" index.html; then
    echo "   🗑️ Removendo seção duplicada..."
    sed -i '/<!-- ===== SEÇÃO QUIZ BÍBLICO ===== -->/,/<\/section>/d' index.html
    echo "   ✅ Seção duplicada removida"
fi

# ============================================
# PASSO 2: CORRIGIR JAVASCRIPT DO QUIZ
# ============================================
echo ""
echo "⚙️ PASSO 2: Corrigindo JavaScript para seção existente..."
...
echo "   ✅ JavaScript corrigido para integração"

echo ""
echo "📋 PARTE 1 CONCLUÍDA"
echo "==================="
echo "✅ HTML limpo (duplicatas removidas)"
echo "✅ JavaScript reescrito para seção existente"
echo "✅ Backup criado: $BACKUP_DIR"
echo ""
echo "🔄 PRÓXIMO PASSO:"
echo "Digite 'continuar' para executar Parte 2 (CSS integrado)"